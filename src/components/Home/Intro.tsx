...
const Intro = () => {
	return (
		<div className="space-y-10">
			...
			<ScrambleText text="testing how to make humans less fragile. currently engineering biological ML systems." settings={{ speed: 0.5 }} />
			...
			<motion.div animate={{ opacity: 1, x: 0 }}>
				<motion.ul variants={animations.containerVariants} initial="hidden" animate="show" className="space-y-10">
					...
					<motion.li variants={animations.itemVariants}>
						<Image src="/profile.jpg" alt="Tina Mai" height={180} width={135} quality={85} priority={true} itemProp="image" />
					</motion.li>
